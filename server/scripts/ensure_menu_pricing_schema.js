...
async function run(){
  ...
  // Degressive Default-Tiers anlegen, falls ein aktives Produkt noch keine Tiers hat.
  ...
  for (const p of prods){
    ...
    const tiers = [
      { g: 1,   price: base },
      { g: 5,   price: Math.round(base*5*0.92) },  // ~8% Rabatt
      { g: 10,  price: Math.round(base*10*0.80) }, // ~20% Rabatt
    ]
